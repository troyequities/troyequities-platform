    ...
    try:
        ...
        for tx in root.findall(".//nonDerivativeTransaction"):
            ...
            if code in ["P", "S"]:
                ...
                # SEC Insiders cannot legally short. Code S is always an equity liquidation.
...
# =====================================================================
# LEG 2: CONGRESSIONAL TRADING PIPELINE
# =====================================================================
...
# =====================================================================
# SPRINT 2: ALGORITHMIC SCORING ENGINE (SIGMOID NORMALIZATION)
# =====================================================================
def generate_alpha_scores(df: pd.DataFrame) -> pd.DataFrame:
    ...
    # 3. Directional Mapping (Differentiating Shorting vs Selling)
    def map_direction(pos):
        if "BUY" in pos:
            return 1.0
        elif "SHORT" in pos:
            return -1.5 # True shorting carries heavier negative conviction
        else:
            return -1.0 # Standard Liquidation

    df["Direction"] = df["Position Type"].apply(map_direction)
